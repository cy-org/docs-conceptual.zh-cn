...
下面的示例重构上例中，[使用扩展方法 (Visual Basic) 重构](../../../../visual-basic/programming-guide/concepts/linq/refactoring-using-an-extension-method.md)，若要在此示例中，若要查找的段落文本移动到纯静态方法的代码中使用纯函数`ParagraphText`。  
