---
title: "BindingNavigator 控件（Windows 窗体） | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 本节内容  
 [BindingNavigator 控件概述](../../../../docs/framework/winforms/controls/bindingnavigator-control-overview-windows-forms.md)  
 介绍 `BindingNavigator` 控件的一般概念，该控件使用户能够浏览数据源的项。  
  
 [如何：使用 Windows 窗体 BindingNavigator 控件定位数据](../../../../docs/framework/winforms/controls/how-to-navigate-data-with-the-windows-forms-bindingnavigator-control.md)  
