---
title: "Button 控件（Windows 窗体） | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 本节内容  
 ...
 另请参阅[如何：使用设计器将 Windows 窗体按钮指定为“接受”按钮](../../../../docs/framework/winforms/controls/designate-a-wf-button-as-the-accept-button-using-the-designer.md)和[如何：使用设计器将 Windows 窗体按钮指定为“取消”按钮](../../../../docs/framework/winforms/controls/designate-a-wf-button-as-the-cancel-button-using-the-designer.md)。  
...
## 相关章节  
 ...
 另请参阅[对话框的用户输入](http://msdn.microsoft.com/zh-cn/63ad8645-6842-45e8-b215-73f778e29a55)和[如何：关闭对话框并保留用户输入](http://msdn.microsoft.com/zh-cn/9e118fad-3bf4-4f70-a3de-a0cda2b0229d)。