...
---
# 如何：旋转图像
本示例演示如何通过使用 <xref:System.Windows.Media.Imaging.BitmapImage> 的 <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> 属性将图像旋转 90 度。  
